...
var _ tfsdk.AttributePlanModifier = (*stringDefaultModifier)(nil)
...
// StringDefault setup a default value for an attribute.
func StringDefault(defaultValue string) tfsdk.AttributePlanModifier {
