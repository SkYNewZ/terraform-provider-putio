...
var _ tfsdk.AttributePlanModifier = (*boolDefaultModifier)(nil)
...
// BoolDefault setup a default value for an attribute.
func BoolDefault(defaultValue bool) tfsdk.AttributePlanModifier {
